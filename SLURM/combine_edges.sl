...
#SBATCH --output        slogs/combine_edges.%j.out
#SBATCH --error         slogs/combine_edges.%j.err
...
python3 /users/kir-fritzsche/aif490/devel/tissue_analysis/lymphnode_analysis/src/utils/combine_edges.py \
