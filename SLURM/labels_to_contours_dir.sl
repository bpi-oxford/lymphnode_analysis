...
#SBATCH --job-name      labels_to_contours_directory
...
#SBATCH --output        slogs/labels_to_contours_directory.%j.out
#SBATCH --error         slogs/labels_to_contours_directory.%j.err
